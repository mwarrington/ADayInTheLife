...
public class MainMenu : MonoBehaviour
{
    ...
    void Menu()
    {
        if (State == MenuState.CREDITS)
        {
            ...
            _credits.transform.position += new Vector3(0, .025f, 0);

            if (_credits.transform.position.y >= 36)
            {
                _credits.transform.position = new Vector3(0, -36, -1);
            }
        }
        else
        {
        ...
        if (Physics.Raycast(ray, out _hit))
        {
            ...
            switch (State)
            {
                ...
                case MenuState.CREDITS:
                    ...
                    _credits.renderer.enabled = true;
                    ...
                    if (_hit.collider.name == "BackButton")
                    {
                        ...
                        if (Input.GetMouseButtonDown(0))
                        {
                            _credits.renderer.enabled = false;
